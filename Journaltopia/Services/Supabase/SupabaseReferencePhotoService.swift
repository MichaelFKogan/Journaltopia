...
enum SupabaseStorageImageCache {
    ...
    static func store(_ data: Data, bucketName: String, storagePath: String) {
        do {
            ...
            print("[Journaltopia] Supabase storage image cache write failed: \(error.localizedDescription)")
        }
    }
    ...
    private static var cacheDirectory: URL {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("JournaltopiaSupabaseImageCache", isDirectory: true)
    }
