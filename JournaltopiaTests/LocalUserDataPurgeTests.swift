...
final class LocalUserDataPurgeTests: XCTestCase {
    ...
    func testPurgeLeavesNothingForTheNextAccount() {
        JournaltopiaLocalAccountScope.setActiveUserID(userA)
        ...
        JournaltopiaLocalAccountScope.setActiveUserID(userB)
        XCTAssertFalse(
            localContentIsPresent(draftID: draftID, title: "UserA"),
    ...
    func testScopedDevicePreferenceKeysAreAlsoPreserved() {
        ...
        XCTAssertFalse(
            LocalUserDataPurge.shouldPurgeUserDefaultsKey(
                JournaltopiaLocalAccountScope.scopedUserDefaultsKey("JournaltopiaSelectedEntryLayout")
            )
        )
        XCTAssertTrue(
            LocalUserDataPurge.shouldPurgeUserDefaultsKey(
                JournaltopiaLocalAccountScope.scopedUserDefaultsKey("JournaltopiaUserChapters")
            )
        )
    }
    ...
    func testForeignUserDefaultsKeysAreLeftAlone() {
        ...
        XCTAssertFalse(LocalUserDataPurge.shouldPurgeUserDefaultsKey("sb-journaltopia-auth-token"))
    ...
    func testAccountOnboardingStateIsPurged() {
        XCTAssertTrue(LocalUserDataPurge.shouldPurgeUserDefaultsKey("JournaltopiaEntriesSampleBannerDismissed"))
        XCTAssertTrue(LocalUserDataPurge.shouldPurgeUserDefaultsKey("JournaltopiaEntriesSamplesCompleted"))
    ...
    func testPurgeContinuesAfterAFailedStep() throws {
        ...
        let blockerURL = cachesURL.appendingPathComponent("JournaltopiaSupabaseImageCache", isDirectory: true)
